...
var data = [], totalPoints = 300;
    ...
    var demo = new countUp("myTargetElement1", 12.52, 21, 0, 6, options);
    demo.start();
    var demo = new countUp("myTargetElement2", 1, 11, 0, 6, options);
    demo.start();
    var demo = new countUp("myTargetElement3", 24.02, 2709, 0, 6, options);
    demo.start();
    var demo = new countUp("myTargetElement4", 1254, 1324, 0, 6, options);
    demo.start();
