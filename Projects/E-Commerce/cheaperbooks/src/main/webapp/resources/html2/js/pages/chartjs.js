$(function () {
	...
	var compChartData = {
        labels : ["Aquino, Mariela","Bague, Yves ","Cabodil, Jude","David, Ekel","Gatan, Ruth","Habag, John","Lopez, Jaena"],
        datasets : [
            {
                fillColor : "rgba(65,139,202,0.5)",
                strokeColor : "rgba(65,139,202,0.5)",
           ...
           function draw4(){
                ...
                var selector = '#comp-chart';

                $(selector).attr( 'width', $(selector).parent().width() )
                  var myComp = new Chart(document.getElementById("comp-chart").getContext("2d")).Comp(compChartData);
            }
          $(window).resize( draw1 );
         draw4()
