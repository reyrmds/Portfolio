...
<head>
    <meta charset="UTF-8">
    <title>Learning Management | Course Category</title>
   ...
   <section class="sidebar">
      <div class="page-sidebar  sidebar-nav">
        ...
        <aside class="right-side">
			...
			<!-- Form -->
			<form:form class="form-horizontal" action="coursecategory/save" method="post" modelAttribute="CourseCategoryModel"><fieldset>
                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input id="coursecategoryname" name="coursecategory_name" type="text" placeholder="Course Category Name" class="form-control"/>
																</div>
                                                            </div>
                                                        </div>
                                                </div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
											   <c:forEach var="x" items="${list}">
                                      			    <tr>
                            			                <td>${x.coursecategory_id }</td>
			                                            <td>${x.coursecategory_name }</td>	
			                                              <td>
                                                   <a class="btn btn-success btn-large" data-toggle="modal" data-href="#responsive" href="#responsive" data-id="${x.coursecategory_id }" data-name="${x.coursecategory_name }">Edit</a>		
													 <a class="btn btn-danger" type="button"  onclick="bura(${x.coursecategory_id})">
                                                        Delete
                                                    </a>
                                                </td>
			                                        </tr>
					...
					<!-- Tables -->
							<!--- responsive model -->
				<form:form class="form-horizontal" id="updateForm" action="coursecategory/update" method="post" modelAttribute="CourseCategoryModel"><fieldset>
                                    ...
                                    <div class="col-md-6">
                                        <!-- <h4>Some More data</h4> -->
                                         <p>
                                           ...
                                           <input id="coursecategoryid" name="coursecategory_id" type="hidden"  class="form-control"  />
                                        </p>
                                        <p>
   ...
   <script src="<c:url value="/resources/js/jquery-1.11.1.min.js"/>"> </script>
    ...
    <!-- end of page level js -->
     ...
     $('#responsive').on('show.bs.modal', function (e) {
   	  ...
   	  var categoryid=$(opener).attr('data-id');
   	  var categoryname=$(opener).attr('data-name');
   	
   	  

   	  //set what we got to our form
	  	  $('#updateForm').find('[id="coursecategoryid"]').val(categoryid);
     	  $('#updateForm').find('[id="coursecategoryname"]').val(categoryname);
     ...
     function bura(x){
			if(confirm("Are you sure you want to delete?") == true){
				window.location.href = 'coursecategory/delete/'+x;
			}
			else{
