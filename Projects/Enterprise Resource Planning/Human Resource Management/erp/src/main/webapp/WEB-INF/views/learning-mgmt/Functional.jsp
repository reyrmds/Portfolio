...
<head>
    <meta charset="UTF-8">
    <title>Functional Competencies </title>
   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
                <!--section starts-->
                <h1>&nbsp FUNCTIONAL COMPETENCIES</h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="http://localhost:8080/competency/dashboard">
                    ...
                    <li class="active">Functional Competencies</li>
                </ol>
            </section>
            <!--section ends-->
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_2" role="grid">
                                        ...
                                        <tbody>
                                           <tr role="row" class="odd">
                                                <td class="sorting_1">Human Resource Management and Development</td>												                                                                                  
                                                <td>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Communications</td>                                                                                 
                                                <td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Environment</td>                                                                                 
												<td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">General Administrative Services</td>                                                                                  
												<td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Public Financial Management</td>                                                                                 
                                                <td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Planning</td>                                                                                   
                                                <td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Social Welfare</td>                                                                                   
                                                <td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Internal Audit</td>                                                                                   
                                               <td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Bids and Award Committee</td>                                                                                   
                                                <td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
