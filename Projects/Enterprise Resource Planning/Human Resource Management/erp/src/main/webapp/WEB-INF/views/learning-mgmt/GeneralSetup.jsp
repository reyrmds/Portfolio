		...
		<aside class="right-side">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">General Setup</li>
				</ol>
			</section>
			<!--section ends-->
					...
					<div class="modal fade in" id="responsive" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
						<div class="modal-dialog">					
							<div class="modal-content">
								<div class="modal-header" style="background-color:#67c5df;">
													...
													<table class="table table-striped table-bordered table-hover">
														<thead class="info" style="color:white;">
															<tr>
																...
																<th  style="color:white; font-size:90%;">Required in Job Group</th>		
										...
										<table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_2" role="grid">
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting_asc" tabindex="0" aria-controls="sample_editable_2" rowspan="1" colspan="1"  col width="35">View</th>		
													<th class="sorting_asc" tabindex="0" aria-controls="sample_editable_2" rowspan="1" colspan="1"  col width="35">Edit</th>			
													<th class="sorting_asc" tabindex="0" aria-controls="sample_editable_2" rowspan="1" colspan="1"  col width="35">Delete</th>				
											...
											<tbody>
											   <tr role="row" class="odd">
													<td class="sorting_1">Core Competencies</td>		
													<td>
														<a class="btn" style="width:35px;  background-color:#a9b6bc; " data-toggle="modal"  onclick="window.location.href='http://localhost:8080/competency/core'">
															<i class="livicon" data-name="eye-open" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
														</a>
													</td>
													<td>
												...
												<tr role="row" class="odd">
													<td class="sorting_1">Leadership Competencies</td>                                                                                 
													
													<td>
														<a class="btn" style="width:35px;  background-color:#a9b6bc; " data-toggle="modal" onclick="window.location.href='http://localhost:8080/competency/leadership'">
															<i class="livicon" data-name="eye-open" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
														</a>
													</td>
												...
												<tr role="row" class="odd">
													<td class="sorting_1">Functional Competencies</td>                                                                                 
													<td>
														<a class="btn" style="width:35px;  background-color:#a9b6bc; " data-toggle="modal" onclick="window.location.href='http://localhost:8080/competency/functional'">
															<i class="livicon" data-name="eye-open" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
														</a>
													</td>
													<td>
