    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>Training Requests Approval</h1>
                <ol class="breadcrumb">
                    <li class="active">
                        <a href="#">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Full Name
                                            : activate to sort column ascending" style="width: 15%;">Trainee Name</th>
                                                
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Edit
                                            : activate to sort column ascending" style="width: 15%;">Course Title</th>
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Delete
                                            ...
                                            : activate to sort column ascending" style="width: 5%;">Status</th>
												<th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Delete
                                            : activate to sort column ascending" style="width: 15%;">Approve / Deny</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr role="row" class="odd">
												...
												<td>
													<center>
														<button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-href="#ok" href="#ok">
														<span class="glyphicon glyphicon-ok"></span>
														</button>
														<button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-href="#deny" href="#deny">
		   ...
		   <!---MODAL MANAGER APPROVAL START--->
			<div class="modal fade" id="ok" tabindex="-1" role="dialog" aria-labelledby="user_delete_confirm_title" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Are you sure you want to approved this traning request? This action is irreversible.
                                        </div>
            ...
            <div class="modal fade" id="deny" tabindex="-1" role="dialog" aria-labelledby="user_delete_confirm_title" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                        ...
                                        <div class="modal-body">
                                            Are you sure you want to deny this traning request? This action is irreversible.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                            <a href="#" type="button" class="btn btn-success">Submit</a>
