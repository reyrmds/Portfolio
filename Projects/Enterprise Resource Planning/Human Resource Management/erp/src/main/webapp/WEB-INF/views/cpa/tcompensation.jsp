                                 ...
                                 <table class="table table-striped table-responsive" id="table1">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td>PHP 10,500.00</td>
                                          <td>
                                             <a href="#" class="btn btn-success" data-toggle="modal" data-target="#modalemp"><span class="glyphicon glyphicon-user"></span> Details</a>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>2001-00121</td>
                                          ...
                                          <td>PHP 30,500.00</td>
                                          <td>
                                             <a href="#" class="btn btn-success"><span class="glyphicon glyphicon-user"></span> Details</a>
                                          </td>
                                       </tr>
                                    </tbody>
                                 </table>
