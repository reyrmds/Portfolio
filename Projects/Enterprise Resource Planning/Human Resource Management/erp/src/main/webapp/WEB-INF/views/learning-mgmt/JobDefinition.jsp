						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">
									...
									Add Competency to Job
								</h4>
							</div>
							<div class="modal-body">
								<div class="input-group col-md-12">									
									<label class="col-md-4 control-label" for="name" style="padding-left:60px;">Job Position</label>										
										<div class="col-md-6">
											<select id="selectbasic" name="selectbasic" class="form-control">
												<option value="0">Choose job position</option>
												<option value="1">Statistician</option>
												<option value="2">Logistics Officer</option>
									...
									<label class="col-md-4 control-label" for="frameName" style="padding-left:60px;">Competency</label>											
										<div class="col-md-6" >
										
										
										<select id="selectbasic" name="selectbasic" class="form-control">
												<option value="0">Choose competency</option>
												<option value="1">Flexible Thinking</option>
												<option value="2">Flexible Thinking</option>
                            ...
                            <div class="panel-heading clearfix  ">
                                <div class="panel-title pull-left">
                                        <div class="caption">
											...
											Job Competency Table
										</div>                                  
                                </div>                      
                            </div>
                            <div class="panel-body">                                
                                <div id="sample_editable_1_wrapper" class="">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_3" role="grid">
										...
										<thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="sample_editable_3" rowspan="1" colspan="1">Job Position</th>
												
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_3" rowspan="1" colspan="1" aria-label="
                                            
											: activate to sort column ascending" style="width: 300px;">Competency Requirement</th>
                                        ...
                                        <tbody>
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">Statistician</td>
