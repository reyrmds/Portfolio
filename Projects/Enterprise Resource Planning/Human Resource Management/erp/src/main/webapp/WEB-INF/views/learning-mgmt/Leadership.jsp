   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
            ...
            <section class="content-header">
                <!--section starts-->
                <h1>&nbsp LEADERSHIP COMPETENCIES</h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="http://localhost:8080/competency/dashboard">
                    ...
                    <li class="active">Leadership Competencies</li>
                </ol>
            </section>
            <!--section ends-->
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_2" role="grid">
                                        ...
                                        <tbody>
                                           <tr role="row" class="odd">
                                                <td class="sorting_1">Building Collaborative and Inclusive Working Relationships</td>												                                                                                  
												<td>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Creating and Nurturing a High Performing Organisation</td>                                                                                 
                                                <td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Leading Change</td>                                                                                 
												<td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Managing Performance and Coaching for Results</td>                                                                                  
												<td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
											...
											<tr role="row" class="odd">
                                                <td class="sorting_1">Thinking Strategically and Creatively</td>                                                                                 
												<td>
                                                    <a class="btn" style="width:35px;  background-color:#f89a14; " data-toggle="modal" data-href="#responsive" href="#responsive">
														<i class="livicon" data-name="pencil" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
													</a>
