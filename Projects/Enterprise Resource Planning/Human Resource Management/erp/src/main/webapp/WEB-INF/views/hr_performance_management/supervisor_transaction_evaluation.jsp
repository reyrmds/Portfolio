  ...
  <div class="wrapper row-offcanvas row-offcanvas-left">
	...
	<%@include file="../includes/sidebar-manager.jsp" %>
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-bordered" id="table2">
                                    ...
                                    <tbody>
										...
										<tr>
                                            <td><center><a href ="/erp/hrms/hr_performance_management//erp/hrms/hr_performance_management/supervisor_evaluation_opcr//">IT Department</a></center></td>
                                        </tr>
                                        
										<tr>
                                            <td><center><a href ="/erp/hrms/hr_performance_management/supervisor_evaluation_opcr/">HR Department</a></center></td>
                                        </tr>

										<tr>
                                            <td><center><a href ="/erp/hrms/hr_performance_management/supervisor_evaluation_opcr/">Maintenance Department</a></center></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
      ...
      <tbody>
                                        <tr>
                                         <td>1.</td>
                                            <td><a href = "/erp/hrms/hr_performance_management/supervisor_evaluation_ipcr/">Mariela Aquino</a></td>
                                        ...
                                        <tr>
                                            <td>2.</td>
                                            <td><a href = "/erp/hrms/hr_performance_management/supervisor_evaluation_ipcr/">Andrei Catapang</a></td>
                                        ...
                                        <tr>
                                            <td>3.</td>
                                            <td><a href = "/erp/hrms/hr_performance_management/supervisor_evaluation_ipcr/">Red Ketchum</a>
                                            </td>
                                            <td>Junior Admin</td>
                                            <td>
                                                Human Resource
                                        ...
                                        <tr>
                                            <td>4.</td>
                                            <td><a href = "/erp/hrms/hr_performance_management/supervisor_evaluation_ipcr/">May Squirtle</a></td>
                                            <td>IT Support</td>
                                            <td>
                                                IT
                                            </td>
                                        ...
                                        <tr>
                                            <td>5.</td>
                                            <td><a href = "/erp/hrms/hr_performance_management/supervisor_evaluation_ipcr/">Goku Son</a></td>
