						...
						<div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                ...
                                <div id="sample_editable_1_wrapper" class="">
                                    <table class="table table-striped table-bordered table-responsive table-hover dataTable" id="sample_editable_1" role="grid">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1">Date Applied</th>
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Full Name
                                            : activate to sort column ascending">Leave Type</th>
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Points
                                            : activate to sort column ascending">Start Date</th>
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Notes
                                            : activate to sort column ascending">End Date</th>
												<th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Delete
...
<script>
		...
		//set what we got to our form
	  	$('#updateReq').find('[id="u_reqEmpID"]').val(emp_id);
	  	$('#updateReq').find('[id="u_lveType"]').val(lve_t);
	  	$('#updateReq').find('[id="u_sDate"]').val(lve_sd);
	  	$('#updateReq').find('[id="u_eDate"]').val(lve_ed);
		//$('#updateReq').find('[id="u_leaveDuration"]').val(lve_nd);
	  	$('#updateReq').find('[id="u_leaveReason"]').val(lve_rs);
	  	$('#updateReq').find('[id="u_leaveRemarks"]').val(lve_rm);
	  	$('#updateReq').find('[id="u_leaveStatus"]').val(lve_s); 
       	$('#updateReq').find('[id="u_fileDate"]').val(lve_fd);
