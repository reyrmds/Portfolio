...
<head>
    <meta charset="UTF-8">
    <title>Learning Management | Employee</title>
...
<aside class="left-side sidebar-offcanvas" style="background-color: rgb(84, 125, 121); min-height: 662px;">
        ...
        <aside class="right-side">
			...
			<!-- Form -->
			<form:form class="form-horizontal" action="employee/save" method="post" modelAttribute="EmployeeModel"><fieldset>
                                    <div class="col-md-6">
                                                    ...
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input id="fname" name="emp_fname" type="text" placeholder="First Name" class="form-control"/>
																</div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                        <i class="livicon" data-name="user-add" data-size="18" data-c="#000" data-hc="#000" data-loop="true"></i>
                                                                    </span>
                                                                    <input id="mname" name="emp_mname" type="text" placeholder="Middle Name" class="form-control"/>
																</div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                   ...
                                                                   <input id="lname" name="emp_lname" type="text" placeholder="Last Name" class="form-control"/>
                                                                </div>
                                                            </div>
                                                        </div>
														<div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                        <i class="livicon" data-name="concrete5" data-size="16" data-loop="true" data-c="#000" data-hc="#000"></i>
                                                                    </span>
														...
														<div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                        <i class="livicon" data-name="home" data-size="16" data-loop="true" data-c="#000" data-hc="#000"></i>
                                                                    </span>
														...
														<div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                        <i class="livicon" data-name="message-add" data-size="16" data-loop="true" data-c="#000" data-hc="#000"></i>
                                                                    </span>
