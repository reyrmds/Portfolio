...
<head>
    <meta charset="UTF-8">
    <title>Learning Management | Enrollment</title>
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>Enrollment</h1>
                        ...
                        <!-- Tables -->
                        <a type="submit" class="btn btn-primary" href="http://127.0.0.1:58979/viewer/frameset?__report=C%3A%5CProgram+Files%5Cbirt%5Cworkspace%5CLMS_DB.rptdesign&__format=html&__svg=true&__locale=en_US&__timezone=Singapore&__masterpage=true&__rtl=false&__cubememsize=10&__resourceFolder=C%3A%5CProgram+Files%5Cbirt%5Cworkspace&-71979662" style="margin-left:940px; margin-bottom:10px;">Generate Report</a>
                     <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered table-hover">
                                       ...
                                       <tbody>
											   <c:forEach var="q" items="${list}">
                                      			    <tr>
                            			                <td>${q.emp_c_e_id }</td>
			                                            <td>${q.emp_c_e_dateofenrollment }</td>
			                                            <td>${q.emp_c_e_dateofcompletion }</td>
			                                            <td>${q.emp_c_e_coursecompleted }</td>	
			                                            <td>${q.emp_fname }</td>	
			                                            <td>${q.emp_mname }</td>
			                                            <td>${q.emp_lname }</td>
			                                            <td>${q.course_name }</td>		
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p>
                                           <input id="coursedescription" name="course_description" type="text" placeholder="Course Description" class="form-control"/>
                                        </p>
                                        <p>
